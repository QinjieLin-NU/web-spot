 ...
 */
 NAV3D.Navigator = function(options) {
    var that = this;
    options = options || {};
    var ros = options.ros;
    ...
    function sendGoal(pose) {
      ...
      var goalMarker = new ROS3D.NavigationArrow({
        size : 15,
        strokeSize : 1,
    ...
    var robotMarker = new ROS3D.NavigationArrow({
      size : 25,
      strokeSize : 1,
      ...
      var mouseEventHandler = function(event, mouseState) {
        ...
        if (mouseState === 'down'){
          ...
          if ( mouseDown === true) {
            ...
            orientationMarker = new ROS3D.NavigationArrow({
              size : 25,
              strokeSize : 1,
