...
echo -e "export COPPELIASIM_ROOT=~/RLBench_ws/Coppelia_ws/CoppeliaSim_Edu" >> $HOME/.bashrc
echo -e "export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:~/RLBench_ws/Coppelia_ws/CoppeliaSim_Edu" >> $HOME/.bashrc
echo -e "export QT_QPA_PLATFORM_PLUGIN_PATH=~/RLBench_ws/Coppelia_ws/CoppeliaSim_Edu" >> $HOME/.bashrc
